...
public class DeptServiceImpl extends ServiceImpl<DeptMapper, Dept> implements DeptService {
    ...
    public Long saveDept(DeptForm formData) {
        ...
        entity.setType(formData.getType());
        entity.setCommissionRate(formData.getCommissionRate());
    ...
    @Override
    public List<DeptVO> getDeptListByType(String type) {
        return null;
    }

    @Override
    public boolean batchUpdateCommissionRate(List<Long> deptIds, BigDecimal commissionRate) {
        return false;
    }
